...
class CategoryOption extends StatelessWidget {
  final Color color;
  const CategoryOption({super.key, required this.color});
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
        Container(
          ...
          height: 35.0,
          width: 35.0,
          child: const Icon(Icons.monitor_heart_outlined, color: Colors.blue),
        ),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: const [
            Text("Health Tracking", style: TextStyle(color: Colors.white)),
            Icon(Icons.arrow_forward_ios_outlined, size: 20.0, color: Colors.white),
          ],
        )
      ]),
    );
