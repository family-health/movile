...
class PendingMemberCard extends GetView<PendingMembersController> {
      ...
      child: ListTile(
          ...
          subtitle:
            ...
            Row(children: [
              ...
              Obx(() {
                String text = "Resend Invitation";

                if (controller.sendingInvitation.value == true) {
                ...
                return TextButton(
                  ...
                  onPressed: (controller.sendingInvitation.value == true)
                      ? null
                      : () async {
                          await controller.resendInvitation(member.email!);
                        },
